...
final class HelpInfoViewModel {
    let categories: [ArkanInfoNew] = [
        ...
        ArkanInfoNew(title: "2. Жизненный Путь", subcategories: [
        ...
        ArkanInfoNew(title: "3. Отношения", subcategories: [
        ...
        ArkanInfoNew(title: "4. Деньги и Финансы", subcategories: [
        ...
        ArkanInfoNew(title: "5. Карьера и Профессия", subcategories: [
        ...
        ArkanInfoNew(title: "6. Здоровье", subcategories: [
        ...
        ArkanInfoNew(title: "7. Таланты и Способности", subcategories: [
        ...
        ArkanInfoNew(title: "8. Испытания и Препятствия", subcategories: [
        ...
        ArkanInfoNew(title: "9. Личностный Рост", subcategories: [
        ...
        ArkanInfoNew(title: "10. Внутренний Мир", subcategories: [
        ...
        ArkanInfoNew(title: "11. Предназначение", subcategories: [
        ...
        ArkanInfoNew(title: "12. Кармические Уроки", subcategories: [
        ...
        ArkanInfoNew(title: "13. Будущее", subcategories: [
