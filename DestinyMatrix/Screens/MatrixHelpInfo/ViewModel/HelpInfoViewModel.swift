...
final class HelpInfoViewModel {
    let categories: [ArkanInfo] = [
        ArkanInfo(title: "1. Число Судьбы", subcategories: [
        ...
        ArkanInfo(title: "2. Жизненный Путь", subcategories: [
        ...
        ArkanInfo(title: "3. Отношения", subcategories: [
        ...
        ArkanInfo(title: "4. Деньги и Финансы", subcategories: [
        ...
        ArkanInfo(title: "5. Карьера и Профессия", subcategories: [
        ...
        ArkanInfo(title: "6. Здоровье", subcategories: [
        ...
        ArkanInfo(title: "7. Таланты и Способности", subcategories: [
        ...
        ArkanInfo(title: "8. Испытания и Препятствия", subcategories: [
        ...
        ArkanInfo(title: "9. Личностный Рост", subcategories: [
        ...
        ArkanInfo(title: "10. Внутренний Мир", subcategories: [
        ...
        ArkanInfo(title: "11. Предназначение", subcategories: [
        ...
        ArkanInfo(title: "12. Кармические Уроки", subcategories: [
        ...
        ArkanInfo(title: "13. Будущее", subcategories: [
